...
<html>
	...
	<body bgcolor="black">
			<div id="main" style="border-color:#404040;background-color:white;">
			<div id="header" style="background-color:#ff4d4d;">

				<span id="resume_builder">CVBUILDER</span>
			</div>
		<div id="select_option">	
		<div id="select_toggle">	
			<a href="#">
			<div class="toggle2" style="background-color:#b30047;border:1px solid #404040;" onclick="show('div1')"><br>
				<span class="option" class="single">Basic</span>
			</div>
			<a href="#">
			<div class="toggle2" style="background-color:#b30047;border:1px solid #404040;" onclick="show('div2')"><br>
				<span class="option">Educational Details</span>
			</div>
			<a href="#">
			<div class="toggle2" style="background-color:#b30047;border:1px solid #404040;" onclick="show('div3')"><br>
				<span class="option">Summer <br>Training</span>
			</div>
			<a href="#">
			<div class="toggle2" style="background-color:#b30047;border:1px solid #404040;" onclick="show('div4')"><br>
				<span class="option">Projects Undertaken</span>
			</div>
			</a>
			<a href="#">
			<div class="toggle2" style="background-color:#b30047;border:1px solid #404040;" onclick="show('div5')"><br>
				<span class="option" class="single">Achievements</span>
			</div>
			</a>
			<a href="#">
			<div class="toggle2" style="background-color:#b30047;border:1px solid #404040;" onclick="show('div6')"><br>
				<span class="option">Skill<br> Set</span>
			</div>
			</a>
			<a href="#">
			<div class="toggle2" style="background-color:#b30047;border:1px solid #404040;" onclick="show('div7')"><br>
				<span class="option">Areas of <br>Interest</span>
			</div>
			</a>
			<a href="#">
			<div class="toggle2" style="background-color:#b30047;border:1px solid #404040;" onclick="show('div8')"><br>
				<span class="option">Personal <br>Details</span>
			</div>
			</a>
			<a href="#">
			<div class="toggle2" style="background-color:#b30047;border:1px solid #404040;" onclick="show('div9')"><br>
		...
		<div id="footer" style="background-color: #ff4d4d;"><br>
			<input type="button" value="Back" id="back" onclick="backPage()">

			<a href="feedback.php" style="margin-left: 40%;position: fixed;">FEEDBACK</a>
